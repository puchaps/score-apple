...
export const reduceChosenItemFromCart = (currentCartItems, reduceItem) => {
...
export const removeChosenItemFromCart = (currentCartItems, removeItem) =>
  currentCartItems.filter((item) => item.id !== removeItem.id)
